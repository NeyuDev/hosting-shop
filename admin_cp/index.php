  ...
  <div class="content-wrapper">
    ...
    <div class="row">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php echo $donhang1; ?> Đơn hàng</td>
                                 <td>
                                  <a href="/admin_cp/pages/taotrangweb/duyettaoweb.php">
                          ...
                          <tr>
                            ...
                            <td><?php echo $donhang2; ?> Đơn hàng</td>
                              <td>
                                  <a href="/admin_cp/pages/taotrangweb/giahanweb.php">
                                      <button class="btn btn-success">Đi tới</button>
                                  </a>
                                  </td>
                          </tr>
      ...
      <div class="col-sm-4 grid-margin">
        ...
        <div class="card">
          <div class="card-body">
            <h5>Tiền thu được năm trước</h5>
            <div class="row">
              <div class="col-8 col-sm-12 col-xl-8 my-auto">
                <div class="d-flex d-sm-block d-md-flex align-items-center">
                  <h2 class="mb-0"><?php echo number_format($tienthuduocnamtruoc); ?></h2>
                  <p class="text-danger ml-2 mb-0 font-weight-medium">VNĐ</p>
                </div>
                <h6 class="text-muted font-weight-normal">Toàn bộ doanh thu năm trước</h6>
              </div>
              <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                <i class="icon-lg mdi mdi-wallet-travel text-danger ml-auto"></i>
              </div>
